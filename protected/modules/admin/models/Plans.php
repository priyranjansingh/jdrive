...
class Plans extends AdminBaseModel
{
	...
	public function rules()
	{
		...
		return array(
			array('id, plan_name, plan_price, plan_duration, created_by, modified_by, date_entered, date_modified', 'required'),
			...
			array('id, plan_name, plan_desc, plan_price, plan_duration, free_duration, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on'=>'search'),
		);
	}

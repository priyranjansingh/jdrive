...
class Users extends AdminBaseModel {
    ...
    public function rules() {
        ...
        return array(
            array('id, username, password, first_name, last_name, email, role_id, created_by, date_entered', 'required'),
            ...
            array('id, s3_bucket, username, password, first_name, last_name, email, phone, profile_pic, state_id, country_id, is_admin, role_id, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on' => 'search'),
        );
    }

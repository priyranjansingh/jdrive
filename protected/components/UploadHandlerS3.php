<?php
require './assets/aws-v2/aws-autoloader.php';
...
class UploadHandlerS3
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $bucket, $acl) {
        ...
        $this->s3 = Aws::factory('./assets/aws-v2/config/config.php')->get('s3')->registerStreamWrapper();
        ...
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|mp3|mp4)$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => '/\.(mp3|mp4)$/i',
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        // pre($this->options['upload_dir'].$this->get_user_path()

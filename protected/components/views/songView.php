<ul class="l_titel">
    ...
    <?php else: ?>
        ...
        <?php else: ?>
            <li>
                <a href="<?php echo base_url().'/chooseplans'; ?>" class="widget_upload" data-song="<?php echo $song_id; ?>" data-user="<?php echo Yii::app()->user->id; ?>" >
                    <i class="fa fa-upload"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url().'/chooseplans'; ?>" class="widget_playlist" data-song="<?php echo $song_id; ?>" data-user="<?php echo Yii::app()->user->id; ?>" >
                    <i class="fa fa-plus"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url().'/chooseplans'; ?>" class="widget_download" data-song="<?php echo $song_id; ?>" data-user="<?php echo Yii::app()->user->id; ?>" >
                    <i class="fa fa-download"></i> <span><?php echo $song_download_count; ?></span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url().'/chooseplans'; ?>" class="widget_like" data-song="<?php echo $song_id; ?>" data-user="<?php echo Yii::app()->user->id; ?>" >
                    <i class="fa fa-heart-o"></i> <span><?php echo $song_like_count; ?></span>
                </a>
            </li>
        <?php endif; ?>
